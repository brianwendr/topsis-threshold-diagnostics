...
Manuscript: **Threshold diagnostics for TOPSIS on ordered alternatives**
...
- `replication_manifest.csv`: compact file-purpose manifest generated by the replication script.
